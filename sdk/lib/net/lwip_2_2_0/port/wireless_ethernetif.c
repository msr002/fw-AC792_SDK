...
__attribute__((weak)) int lwip_low_level_output_filter(u8_t *pkg, u32_t len)
{
    return 0;
}

__attribute__((weak)) int lwip_low_level_inputput_filter(u8_t *pkg, u32_t len)
{
    return 0;
}
...
static void low_level_init(struct netif *netif)
{
    ...
    int wifi_get_mac(unsigned char *mac);
