...
void p33_unlock(void);

u8 p33_spicon_clock_div(u8 div);
...
#define P3_DCD_CON0                   0x09
#define P3_DCD_CON1                   0x0a
#define P3_DVD_CON0                   0x0b
#define P3_DVD_CON1                   0x0c
#define P3_ANA_MFIX                   0x0d
...
#define P3_RTC_CON0                   0x19
#define P3_AVD18_CON0                 0x1a
#define P3_AVD28_CON0                 0x1b
...
#define P3_PCNT_SET0                  0x9b
#define P3_PCNT_SET1                  0x9c
#define P3_PCNT_DAT0                  0x9d
#define P3_PCNT_DAT1                  0x9e

//............. 0X00A0 - 0X00AF............
#define P3_PR_PWR                     0xa0

#define P3_RTC_ADC0                   0xa3
...
#define P3_EFUSE_CON2                 0xb2
#define P3_EFUSE_RDAT                 0xb3
#define P3_EFUSE_PU_DAT0              0xb4
#define P3_EFUSE_PU_DAT1              0xb5
#define P3_EFUSE_PU_DAT2              0xb6
#define P3_EFUSE_PU_DAT3              0xb7
...
#define P3_LS_ADC                     0xd3
#define P3_LS_SDDR                    0xd4
#define P3_LS_USB11                   0xd5
#define P3_LS_USB20                   0xd6
#define P3_LS_RWF                     0xd7
#define P3_LS_PLL2                    0xd8
#define P3_LS_AUDIO                   0xd9
...
//............. 0x00f0 - 0x00ff............
#define P3_PV_OUT                     0xf0
#define P3_PV_DIR                     0xf1
#define P3_PV_DIE                     0xf2
#define P3_PV_PU                      0xf3
#define P3_PV_PD                      0xf4
#define P3_PV_HD                      0xf5
#define P3_PV_IN                      0xf6
...
#define R3_WKUP_FLT_EN0               (0x90 | RTC_SFR_BEGIN)
#define R3_WKUP_P_IE0                 (0x91 | RTC_SFR_BEGIN)
#define R3_WKUP_N_IE0                 (0x92 | RTC_SFR_BEGIN)
#define R3_WKUP_CLK_SEL               (0x93 | RTC_SFR_BEGIN)
#define R3_WKUP_LEVEL0                (0x94 | RTC_SFR_BEGIN)
#define R3_WKUP_P_PND0                (0x95 | RTC_SFR_BEGIN)
#define R3_WKUP_N_PND0                (0x96 | RTC_SFR_BEGIN)
#define R3_WKUP_P_CPND0               (0x97 | RTC_SFR_BEGIN)
#define R3_WKUP_N_CPND0               (0x98 | RTC_SFR_BEGIN)

#define R3_PR_IN                      (0x99 | RTC_SFR_BEGIN)
#define R3_PR_OUT                     (0x9a | RTC_SFR_BEGIN)
#define R3_PR_DIR                     (0x9b | RTC_SFR_BEGIN)
#define R3_PR_DIE                     (0x9c | RTC_SFR_BEGIN)
#define R3_PR_PU                      (0x9d | RTC_SFR_BEGIN)
#define R3_PR_PD                      (0x9e | RTC_SFR_BEGIN)
#define R3_PR_HD                      (0x9f | RTC_SFR_BEGIN)
...
#define R3_RST_LV0                    (0xaa | RTC_SFR_BEGIN)
