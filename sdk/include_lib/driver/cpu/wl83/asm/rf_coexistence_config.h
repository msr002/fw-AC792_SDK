...
typedef enum : u8 {
    RF_COEXISTENCE_SCENE_PHONE_CALL,
    ...
    RF_COEXISTENCE_SCENE_TWS_A2DP_PLAY,
    RF_COEXISTENCE_SCENE_A2DP_PLAY,
    RF_COEXISTENCE_SCENE_BIS_TX,
    RF_COEXISTENCE_SCENE_BIS_RX,
    RF_COEXISTENCE_SCENE_PAGE_DEVICE,
    RF_COEXISTENCE_SCENE_TWS_CONNECT,
    RF_COEXISTENCE_SCENE_EDR_CONNECT,
