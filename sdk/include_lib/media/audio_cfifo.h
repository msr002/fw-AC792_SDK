 ...
 * 获取audio cfifo内的数据
 * INPUT    :  fifo - 主fifo结构指针
 * OUTPUT   : out_buf 输出地址, len 要读取的长度
 * WARNINGS :  无.
 * RETURN  :   输出长度
 *=======================================================================*/
 ...
 * RETURN  :   写偏移
 *=======================================================================*/
int audio_cfifo_get_fifo_wp(struct audio_cfifo *fifo);
 ...
 * RETURN  :   读偏移
 *=======================================================================*/
int audio_cfifo_get_fifo_rp(struct audio_cfifo *fifo);

/*************************************************************************
 * 获取audio cfifo 采样样点的总大小
 * INPUT    :  fifo - 主fifo结构指针
 * WARNINGS :  无.
 * RETURN  :   采样样点的总大小
 *=======================================================================*/
int audio_cfifo_get_fifo_sample_size(struct audio_cfifo *fifo);
 ...
 * WARNINGS :  无.
 *=======================================================================*/
int audio_cfifo_channel_add_with_fifo_rp(struct audio_cfifo *fifo, struct audio_cfifo_channel *new_ch, int delay_time, u8 write_mode, u16 fifo_rp);
