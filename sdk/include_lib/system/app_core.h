...
#define ACTION_REPLACE              0x0a1b2c03
...
struct application_operation {
    ...
    int (*msg_handler)(struct application *, int *msg);
};
...
struct application *__get_current_app(void);
...
void app_core_msg_handler(int *msg);

int app_msg_handler(const char *app_name, int msg);
