 ...
 */
PJ_INLINE(int) pj_isalnum(unsigned char c)
{
    return isalnum(c);
}
 ...
 *              alphabetic character.
 */
PJ_INLINE(int) pj_isalpha(unsigned char c)
{
    return isalpha(c);
}
 ...
 *              an ASCII character.
 */
PJ_INLINE(int) pj_isascii(unsigned char c)
{
    return c < 128;
}
 ...
 *              a decimal-digit character.
 */
PJ_INLINE(int) pj_isdigit(unsigned char c)
{
    return isdigit(c);
}
 ...
 *              a space character (0x09 - 0x0D or 0x20).
 */
PJ_INLINE(int) pj_isspace(unsigned char c)
{
    return isspace(c);
}
 ...
 *              a lowercase character.
 */
PJ_INLINE(int) pj_islower(unsigned char c)
{
    return islower(c);
}
 ...
 *              a uppercase character.
 */
PJ_INLINE(int) pj_isupper(unsigned char c)
{
    return isupper(c);
}
 ...
 *              tab ('\\t') character.
 */
PJ_INLINE(int) pj_isblank(unsigned char c)
{
    return (c == ' ' || c == '\t');
}
 ...
 */
PJ_INLINE(int) pj_tolower(unsigned char c)
{
    return tolower(c);
}
 ...
 */
PJ_INLINE(int) pj_toupper(unsigned char c)
{
    return toupper(c);
}
 ...
 *              an hexadecimal digit character.
 */
PJ_INLINE(int) pj_isxdigit(unsigned char c)
{
    return isxdigit(c);
}
