...
enum {
    ...
    APP_MSG_VIDEO_CALL_BOTTOM,
    APP_MSG_VIDEO_CALL_MAIN,
    APP_MSG_VIDEO_CALL_DEVICE_ONLINE,
    APP_MSG_VIDEO_CALL_DEVICE_OFFLINE,
    APP_MSG_VIDEO_CALL_ADD_STREAM_RECV,
    APP_MSG_VIDEO_CALL_DEL_STREAM_RECV,
    APP_MSG_VIDEO_CALL_OPEN_STREAM,
    APP_MSG_VIDEO_CALL_CLOSE_STREAM,
    APP_MSG_VIDEO_CALL_TOP,
