...
lv_obj_t *setup_scr_pair_options(lv_ui *ui)
{
    ...
    ui_style_set(ui_scr->pair_options, GUI_CTRL_SCR);
    ...
    ui_style_set(ui_scr->pair_options_imgbtn_1, GUI_CTRL_IMGBTN);
    ...
    ui_style_set(ui_scr->pair_options_imgbtn_2, GUI_CTRL_IMGBTN);
    ...
    ui_style_set(ui_scr->pair_options_lbl_1, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->pair_options_lbl_2, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->pair_options_imgbtn_4, GUI_CTRL_IMGBTN);
