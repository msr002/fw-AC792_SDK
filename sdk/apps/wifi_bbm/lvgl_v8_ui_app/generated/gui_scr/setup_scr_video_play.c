...
#if LV_USE_GUIBUILDER_SIMULATOR
    "A:\\1111\\ac792\\ui_prj\\wifi_bbm_800x480\\import\\image\\video_play.png",
    "A:\\1111\\ac792\\ui_prj\\wifi_bbm_800x480\\import\\image\\video_pause.png"
#else
...
lv_obj_t *setup_scr_video_play(lv_ui *ui)
{
    ...
    ui_style_set(ui_scr->video_play_imglist_1, GUI_CTRL_IMGLIST);
    ...
    ui_style_set(ui_scr->video_play_imgbtn_3, GUI_CTRL_IMGBTN);
    ...
    //Delete extra default style for video_play_imgbtn_3
    lv_obj_remove_style(ui_scr->video_play_imgbtn_3, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_remove_style(ui_scr->video_play_imgbtn_3, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    //Delete extra default style for video_play_imgbtn_2
    lv_obj_remove_style(ui_scr->video_play_imgbtn_2, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_remove_style(ui_scr->video_play_imgbtn_2, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    ui_style_set(ui_scr->video_play_bar_1, GUI_CTRL_BAR);
