...
lv_obj_t *setup_scr_file_browser(lv_ui *ui)
{
    ...
    ui_style_set(ui_scr->file_browser, GUI_CTRL_SCR);
    ...
    ui_style_set(ui_scr->file_browser_view_2, GUI_CTRL_CONT);
    ...
    //Delete extra default style for file_browser_view_2
    lv_obj_remove_style(ui_scr->file_browser_view_2, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    ui_style_set(ui_scr->file_browser_imgbtn_1, GUI_CTRL_IMGBTN);
    ...
    ui_style_set(ui_scr->file_browser_imgbtn_2, GUI_CTRL_IMGBTN);

    //Delete extra default style for file_browser_imgbtn_2
    lv_obj_remove_style(ui_scr->file_browser_imgbtn_2, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_remove_style(ui_scr->file_browser_imgbtn_2, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    ui_style_set(ui_scr->file_browser_imgbtn_3, GUI_CTRL_IMGBTN);

    //Delete extra default style for file_browser_imgbtn_3
    lv_obj_remove_style(ui_scr->file_browser_imgbtn_3, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_remove_style(ui_scr->file_browser_imgbtn_3, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    ui_style_set(ui_scr->file_browser_lbl_1, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_imgbtn_4, GUI_CTRL_IMGBTN);
    ...
    //Delete extra default style for file_browser_imgbtn_4
    lv_obj_remove_style(ui_scr->file_browser_imgbtn_4, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    ui_style_set(ui_scr->file_browser_browser_cont, GUI_CTRL_CONT);
    ...
    //Delete extra default style for file_browser_browser_cont
    lv_obj_remove_style(ui_scr->file_browser_browser_cont, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    ui_style_set(ui_scr->file_browser_file_cont1, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_1, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_2, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_1, GUI_CTRL_CHECKBOX);
    ...
    ui_style_set(ui_scr->file_browser_file_cont2, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_2, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_3, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_2, GUI_CTRL_CHECKBOX);
    ...
    ui_style_set(ui_scr->file_browser_file_cont3, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_3, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_4, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_3, GUI_CTRL_CHECKBOX);
    ...
    ui_style_set(ui_scr->file_browser_file_cont4, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_4, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_5, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_4, GUI_CTRL_CHECKBOX);
    ...
    ui_style_set(ui_scr->file_browser_file_cont5, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_5, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_6, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_5, GUI_CTRL_CHECKBOX);
    ...
    ui_style_set(ui_scr->file_browser_file_cont6, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->file_browser_img_6, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->file_browser_lbl_7, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->file_browser_cb_6, GUI_CTRL_CHECKBOX);
