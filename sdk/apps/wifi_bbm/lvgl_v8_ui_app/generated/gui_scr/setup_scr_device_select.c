...
lv_obj_t *setup_scr_device_select(lv_ui *ui)
{
    ...
    ui_style_set(ui_scr->device_select, GUI_CTRL_SCR);
    ...
    ui_style_set(ui_scr->device_select_view_1, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->device_select_img_1, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->device_select_lbl_2, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->device_select_view_2, GUI_CTRL_CONT);
    ...
    ui_style_set(ui_scr->device_select_img_2, GUI_CTRL_IMG);
    ...
    ui_style_set(ui_scr->device_select_lbl_3, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->device_select_lbl_1, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->device_select_imgbtn_1, GUI_CTRL_IMGBTN);
