...
lv_obj_t *setup_scr_sys_options(lv_ui *ui)
{
    ...
    ui_style_set(ui_scr->sys_options, GUI_CTRL_SCR);
    ...
    ui_style_set(ui_scr->sys_options_view_1, GUI_CTRL_CONT);
    ...
    //Delete extra default style for sys_options_view_1
    lv_obj_remove_style(ui_scr->sys_options_view_1, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    ui_style_set(ui_scr->sys_options_lbl_1, GUI_CTRL_LABEL);
    ...
    ui_style_set(ui_scr->sys_options_btn_1, GUI_CTRL_BUTTON);
    ...
    ui_style_set(ui_scr->sys_options_btn_2, GUI_CTRL_BUTTON);
