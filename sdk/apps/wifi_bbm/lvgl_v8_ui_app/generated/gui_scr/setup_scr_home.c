...
#else
    lv_imgbtn_set_src(ui->home_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/55000000.zip", NULL);
#endif
...
#else
    lv_imgbtn_set_src(ui->home_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/55000001.zip", NULL);
#endif
