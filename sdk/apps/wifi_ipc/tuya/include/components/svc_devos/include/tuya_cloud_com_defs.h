...
#if defined(ENABLE_DEV_EVT_NOTIFY) && (ENABLE_DEV_EVT_NOTIFY == 1)
#define GW_DEV_EVT_NOTIY(evt, action, ctx) gw_dev_evt_notify(evt, action, ctx)
#else
#define GW_DEV_EVT_NOTIY(evt, action, ctx)
#endif
