...
#define LOGO_USE_USER  1

#define TY_DEVICE_TEST_NULL             0
#define TY_DEVICE_TEST_WIFI             1
#define TY_DEVICE_TEST_SOUND_START      2
#define TY_DEVICE_TEST_SOUND_STOP       3
#define TY_DEVICE_TEST_PRE_LCD_TEST     4
#define TY_DEVICE_TEST_LCD_START        5
#define TY_DEVICE_TEST_LCD_STOP         6
#define TY_DEVICE_TEST_END              7
/* Export functions ----------------------------------------------------------*/
