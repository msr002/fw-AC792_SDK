...
STATIC UINT_T PCM_SAMPLE_RATE = 8000;
...
//    fp = fopen("storage/sd0/C/abc.pcm", "w+");
//    if(fp == NULL) {
//        PR_DEBUG("open file error");
//    } else {
//        PR_DEBUG("open file succ");
//    }
...
//    BOOL_T doorbell_st = FALSE;
//    extern INT_T  door_bell_init_value;
//    #define  DOOR_BELL_WAKE_UP_BIT              U8_BIT(2)
//    if(0xff != wk_up_pin) {
//        if(ty_get_static_electricity()) {
//            if(ty_get_local_ring() && (wk_up_pin & DOOR_BELL_WAKE_UP_BIT) && false == ty_is_in_mf_test())
//            {
//                doorbell_st = TRUE;
//            }
//        } else {
//
//            if(ty_get_local_ring() && ((wk_up_pin & DOOR_BELL_WAKE_UP_BIT) && (door_bell_init_value)) && false == ty_is_in_mf_test())
//            {
//                doorbell_st = TRUE;
//            }
//        }
//
//        if(doorbell_st) {
//            tuya_audio_hw_local_play(APP_LOCAL_PROMPT_DOOR_CALL);
//        }
//    }
//    extern BOOL_T  door_bell_init_up;
//    if(ty_get_local_ring() &&door_bell_init_up && false == ty_is_in_mf_test()) {
//        tuya_audio_hw_local_play(APP_LOCAL_PROMPT_DOOR_CALL);
//    }
    init = 1;
}
