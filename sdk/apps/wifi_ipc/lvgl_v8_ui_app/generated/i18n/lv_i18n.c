...
static lv_i18n_phrase_t en_singulars[] = {
    { "back", "back", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "ScanCode", "Please perform Bluetooth or scan code network configuration", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "app", "application", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "netcfg", "configure network", "lv_font_FangZhengKaiTiJianTi_1_18" },
    { "syscfg", "system configure", "lv_font_FangZhengKaiTiJianTi_1_18" },
    { "language", "language", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "sysinfo", "information", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "return_sysset", "system Setting", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_app", "application", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_language", "language", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "resetinfo", "Restart in 3 seconds to enter distribution network mode", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_sysinfo", "information", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { NULL, NULL, NULL }
};
...
static lv_i18n_phrase_t zh_cn_singulars[] = {
    { "back", "返回", "lv_font_FangZhengKaiTiJianTi_1_22" },
    { "ScanCode", "请进行蓝牙或者扫码配网", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "app", "下载app", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "netcfg", "配网", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "syscfg", "系统配置", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "language", "语言", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "sysinfo", "详情", "lv_font_FangZhengKaiTiJianTi_1_20" },
    { "return_sysset", "系统设置", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_app", "app下载", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_language", "语言", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "resetinfo", "3秒后重启进入配网模式", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { "return_info", "", "lv_font_FangZhengKaiTiJianTi_1_18" },
    { "return_sysinfo", "详情", "lv_font_FangZhengKaiTiJianTi_1_32" },
    { NULL, NULL, NULL }
};
...
static const font_mapping_t font_mapping[] = {
    ...
    {"lv_font_FangZhengKaiTiJianTi_1_32", &lv_font_FangZhengKaiTiJianTi_1_32},
    {"lv_font_FangZhengKaiTiJianTi_1_18", &lv_font_FangZhengKaiTiJianTi_1_18},
