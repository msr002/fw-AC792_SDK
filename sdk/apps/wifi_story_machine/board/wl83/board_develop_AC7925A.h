#if defined CONFIG_BOARD_DEVELOP && defined CONFIG_BOARD_AC7925A
...
//                                  UART配置                                       //
//*********************************************************************************//
#define TCFG_DEBUG_PORT                     IO_PORTA_05
#define TCFG_UBOOT_DEBUG_PORT               PA05
...
#define TCFG_SD0_PORTS_GROUP                'D'            //'A''B''C''D'表示使用固定组IO
...
#define TCFG_HW_IIC1_SCL_IO                 IO_PORTA_07
...
#define TCFG_LINEIN_IO_PORT                 {-1/*AUX0P*/, -1/*AUX0N*/, IO_PORTC_04/*AUX1P*/, IO_PORTC_05/*AUX1N*/}
