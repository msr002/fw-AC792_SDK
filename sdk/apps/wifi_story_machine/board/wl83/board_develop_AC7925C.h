#if defined CONFIG_BOARD_DEVELOP && defined CONFIG_BOARD_AC7925C
...
//                                  UART配置                                       //
//*********************************************************************************//
#define TCFG_DEBUG_PORT                     IO_PORTE_12
#define TCFG_UBOOT_DEBUG_PORT               PE12
...
#define TCFG_SD0_PORTS_GROUP                'C'            //'A''B''C''D'表示使用固定组IO
...
#define CONFIG_AUDIO_LINEIN_CHANNEL_MAP     1
...
#define TCFG_RTC_CLK_SEL                    CLK_SEL_LRC
...
#define TCFG_VIDEO3_CAMERA_RESET            -1
