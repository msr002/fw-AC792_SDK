#if defined CONFIG_BOARD_DEVELOP && defined CONFIG_BOARD_TC7920
...
#define TCFG_SYS_CLK                        360000000         //240M,192M,160M,120M,96M,80M,64M,60M,48M,40M,32M,24M，其他值时启用SYS_PLL
...
#define TCFG_VIDEO_CLK                      240000000         //EVA/PUB时钟，240M,192M,160M,120M,96M,80M,64M,60M,48M，其他值时启用SYS_PLL或者DDR_PLL
...
#endif
#define TCFG_SDRAM_MODE                     0              //0-sdram    1-ddr1
...
#define TCFG_VIDEO3_CAMERA_PWDN             IO_PORTE_11
#define TCFG_VIDEO3_CAMERA_INTERFACE        2//SEN_INTERFACE_CSI2
#endif // CONFIG_VIDEO3_ENABLE

#define TCFG_SLAVE_UVC0_JPEG_DATA_SOURCE    "video1.2"
#define TCFG_SLAVE_UVC1_JPEG_DATA_SOURCE    "video0.2"
#define TCFG_SLAVE_UVC0_YUV_DATA_SOURCE     "video1.2"
