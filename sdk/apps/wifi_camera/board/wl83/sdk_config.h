...
#define USB_DEVICE_CLASS_CONFIG                   (MASSSTORAGE_CLASS | UVC_CLASS) // FUSB从机模式
#define USB_DEVICE_CLASS_CONFIG_2_0               (MASSSTORAGE_CLASS | UVC_CLASS) // HUSB从机模式
...
#define TCFG_BT_SUPPORT_PROFILE_SPP               0                // SPP
#define TCFG_BT_SUPPORT_PROFILE_HFP               0                // HFP
...
#define TCFG_DEC_MIDI_FILE_ENABLE                 0                // MIDI_FILE
