...
void i18n_refresh_texts(const char *page_name)
{
    ...
    if (strcmp(page_name, "usb_slave") == 0 && guider_ui.usb_slave) {
    ...
    if (strcmp(page_name, "video_file") == 0 && guider_ui.video_file) {
    ...
    if (strcmp(page_name, "video_dec") == 0 && guider_ui.video_dec) {
    ...
    if (strcmp(page_name, "video_dec_options") == 0 && guider_ui.video_dec_options) {
