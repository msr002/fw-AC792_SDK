...
#if LV_USE_GUIBUILDER_SIMULATOR
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\dec\\video.png",
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\dec\\photo.png"
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\rec\\rec_scan\\card_offline.png",
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\rec\\rec_scan\\card_online.png"
#else
    "mnt/sdfile/EXT_RESERVED/uipackres/ui/4b000080.zip",
    "mnt/sdfile/EXT_RESERVED/uipackres/ui/4b000039.zip"
#endif
};
static const char *video_dec_imglist_3_imgs[2] = {
#if LV_USE_GUIBUILDER_SIMULATOR
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\dec\\play.png",
    "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\LY_UI\\dec\\pause.png"
#else
...
lv_obj_t *setup_scr_video_dec(lv_ui *ui)
{
    ...
    lv_obj_add_style(ui->video_dec, &gui_scr_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->video_dec, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_scan, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->video_dec_view_scan, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_opa(ui->video_dec_view_scan, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_imglist_1, &gui_imglist_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_edit_2, &gui_ta_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_dec_edit_2. Part: LV_PART_SCROLLBAR, State: LV_STATE_DEFAULT
    lv_obj_add_style(ui->video_dec_edit_2, &gui_ta_scrollbar_default_style, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_edit_3, &gui_ta_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_dec_edit_3. Part: LV_PART_SCROLLBAR, State: LV_STATE_DEFAULT
    lv_obj_add_style(ui->video_dec_edit_3, &gui_ta_scrollbar_default_style, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_imglist_2, &gui_imglist_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_1, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_opa(ui->video_dec_view_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_opa(ui->video_dec_view_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_imglist_3, &gui_imglist_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_edit_1, &gui_ta_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_edit_1, &gui_ta_scrollbar_default_style, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_1, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_dec_img_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_5, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_4, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_color(ui->video_dec_view_4, lv_color_make(0x21, 0x95, 0xF6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_dec_view_4, 91, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_2, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_dec_view_2. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_dec_view_2, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_dec_img_2, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_lbl_1, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_view_3, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_dec_view_3. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_dec_view_3, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_dec_img_3, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_lbl_2, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_4, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_dec_img_4, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_5, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_dec_img_5, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_6, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_color(ui->video_dec_img_6, lv_color_make(0x42, 0xA5, 0xF5), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_7, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->video_dec_img_7, lv_color_make(0x42, 0xA5, 0xF5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui->video_dec_img_7, lv_color_make(0x42, 0xA5, 0xF5), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_dec_img_7, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_8, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_9, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_10, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_dec_img_11, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
