...
lv_obj_t *setup_scr_video_play(lv_ui *ui)
{
    ...
    //Delete extra default style for video_play_view_1
    lv_obj_remove_style(ui_scr->video_play_view_1, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_text_align(ui_scr->video_play_lbl_cur_time, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui_scr->video_play_img_prev_file, 24, 48);
    ...
    lv_obj_set_pos(ui_scr->video_play_img_next_file, 149, 48);
    ...
    lv_obj_set_style_text_align(ui_scr->video_play_lbl_total_time, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui_scr->video_play_ddlist_multi_spped, 12, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_opa(ui_scr->video_play_ddlist_multi_spped, 128, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_imgbtn_set_src(ui_scr->video_play_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, gui_get_res_path(GUI_RES_PHOTO_1_PNG), NULL);
    lv_imgbtn_set_src(ui_scr->video_play_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, gui_get_res_path(GUI_RES_PHOTO_ON_PNG), NULL);
    lv_imgbtn_set_src(ui_scr->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, gui_get_res_path(GUI_RES_PHOTO_1_PNG), NULL);
    ...
    lv_obj_set_style_text_align(ui_scr->video_play_lbl_msg, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
