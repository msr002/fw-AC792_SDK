...
lv_obj_t *setup_scr_sys_prompt(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->sys_prompt_img_warn, "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\pop_up_window.png");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->sys_prompt_img_2, "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\flig_on.png");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->sys_prompt_img_1, "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\astern.png");
#else
