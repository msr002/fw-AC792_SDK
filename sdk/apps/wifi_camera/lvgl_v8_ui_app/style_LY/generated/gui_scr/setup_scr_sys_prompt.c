...
lv_obj_t *setup_scr_sys_prompt(lv_ui *ui)
{
    ...
    lv_obj_set_style_clip_corner(ui->sys_prompt_img_warn, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->sys_prompt_img_warn, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->sys_prompt_img_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor(ui->sys_prompt_img_warn, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor_opa(ui->sys_prompt_img_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->sys_prompt_img_warn, "A:\\gitlab\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\pop_up_window.png");
#else
    lv_img_set_src(ui->sys_prompt_img_warn, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000024.rle");
#endif
    ...
    const lv_font_t *sys_prompt_lbl_warn_font = _font("sd_update");
    if (sys_prompt_lbl_warn_font == NULL) {
        sys_prompt_lbl_warn_font = &lv_font_FangZhengKaiTiJianTi_1_48;
    }
    ...
    lv_obj_set_style_bg_opa(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->sys_prompt_lbl_warn, lv_color_make(0xFF, 0xFF, 0xFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->sys_prompt_lbl_warn, sys_prompt_lbl_warn_font, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->sys_prompt_lbl_warn, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->sys_prompt_lbl_warn, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->sys_prompt_lbl_warn, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->sys_prompt_lbl_warn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_clip_corner(ui->sys_prompt_img_2, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->sys_prompt_img_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->sys_prompt_img_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor(ui->sys_prompt_img_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_recolor_opa(ui->sys_prompt_img_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->sys_prompt_img_2, "A:\\gitlab\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\flig_on.png");
#else
    lv_img_set_src(ui->sys_prompt_img_2, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000025.rle");
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->sys_prompt_img_1, "A:\\gitlab\\ac792\\ui_prj\\dvr_ly_800x480\\import\\image\\video_page\\astern.png");
#else
    lv_img_set_src(ui->sys_prompt_img_1, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000026.rle");
#endif
