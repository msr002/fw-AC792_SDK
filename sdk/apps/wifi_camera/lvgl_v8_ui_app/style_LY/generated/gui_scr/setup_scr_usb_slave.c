...
lv_obj_t *setup_scr_usb_slave(lv_ui *ui)
{
    ...
    if (usb_slave_btn_usb_msd_font == NULL) {
        usb_slave_btn_usb_msd_font = &lv_font_FangZhengKaiTiJianTi_1_22;
    }
    ...
    if (usb_slave_btn_pc_cam_font == NULL) {
        usb_slave_btn_pc_cam_font = &lv_font_FangZhengKaiTiJianTi_1_22;
    }
    ...
    if (usb_slave_btn_video_rec_font == NULL) {
        usb_slave_btn_video_rec_font = &lv_font_FangZhengKaiTiJianTi_1_22;
    }
