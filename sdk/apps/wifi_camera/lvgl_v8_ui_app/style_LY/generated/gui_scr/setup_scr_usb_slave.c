...
lv_obj_t *setup_scr_usb_slave(lv_ui *ui)
{
    ...
    lv_obj_add_style(ui->usb_slave_btn_usb_msd, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->usb_slave_btn_usb_msd, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->usb_slave_btn_pc_cam, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->usb_slave_btn_pc_cam, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->usb_slave_btn_video_rec, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->usb_slave_btn_video_rec, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
