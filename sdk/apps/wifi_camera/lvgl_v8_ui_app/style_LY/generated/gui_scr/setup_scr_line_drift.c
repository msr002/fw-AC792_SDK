...
lv_obj_t *setup_scr_line_drift(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui_scr->line_drift, lv_color_make(0x55, 0xaa, 0xa5), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui_scr->line_drift_lbl_3, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_scr->line_drift_lbl_3, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    //Delete extra default style for line_drift_view_2
    lv_obj_remove_style(ui_scr->line_drift_view_2, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_text_align(ui_scr->line_drift_lbl_7, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_scr->line_drift_lbl_7, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui_scr->line_drift_lbl_6, 732, 229);
    ...
    lv_obj_set_style_text_align(ui_scr->line_drift_lbl_6, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_scr->line_drift_lbl_6, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
