...
lv_obj_t *setup_scr_line_drift(lv_ui *ui)
{
    ...
    if (line_drift_btn_horizon_font == NULL) {
        line_drift_btn_horizon_font = &lv_font_FangZhengKaiTiJianTi_1_24;
    }
    ...
    if (line_drift_btn_carhead_font == NULL) {
        line_drift_btn_carhead_font = &lv_font_FangZhengKaiTiJianTi_1_24;
    }
    ...
    if (line_drift_lbl_7_font == NULL) {
        line_drift_lbl_7_font = &lv_font_FangZhengKaiTiJianTi_1_16;
    }
    ...
    if (line_drift_lbl_6_font == NULL) {
        line_drift_lbl_6_font = &lv_font_FangZhengKaiTiJianTi_1_16;
    }
