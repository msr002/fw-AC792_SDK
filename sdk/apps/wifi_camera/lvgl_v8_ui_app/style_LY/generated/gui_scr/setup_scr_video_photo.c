...
lv_obj_t *setup_scr_video_photo(lv_ui *ui)
{
    ...
    lv_obj_add_style(ui->video_photo_view_scan, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_taking_photo, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_photo_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_exp_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_awb_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_iso_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_qua_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_delay_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_shake_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_repeat_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_sd_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_bat_icon, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_lbl_photo_reso, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_lbl_remain_pnum, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_menu_b, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->video_photo_view_menu_b, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_menu, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(ui->video_photo_view_menu, lv_color_make(0x21, 0x95, 0xF6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->video_photo_view_menu, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_color(ui->video_photo_view_menu, lv_color_make(0x21, 0x95, 0xF6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_photo_view_menu, 91, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_phm, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_phm. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_phm, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_lbl_1, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_reso, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_reso. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_reso, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_img_2, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_cyt, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_cyt. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_cyt, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_view_qua, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_qua. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_qua, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_view_acu, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_acu. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_acu, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_view_wbl, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_wbl. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_wbl, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_img_6, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_col, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_col. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_col, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_view_iso, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_iso. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_iso, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_view_pexp, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_pexp. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_pexp, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_lbl_9, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_sok, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_sok. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_sok, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_lbl_10, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_sca, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_sca. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_sca, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_img_11, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_lbl_11, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_pdat, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_photo_view_pdat. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_photo_view_pdat, &gui_cont_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_lbl_12, &gui_label_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_img_14, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_photo_img_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_opa(ui->video_photo_img_15, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_view_submenu, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_1, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_1, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_2, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_2, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_3, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_3, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_4, &gui_btn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_photo_submenu_btn_4, &gui_btn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
