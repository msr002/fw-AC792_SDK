...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\project\\meter_ui_demo\\WL83_gitlab\\ac792\\ui_prj\\new_ui\\sdk\\ui_res\\flash\\rle\\font\\35000000.rle");
#else
...
#else
    lv_font_t *fnt_font = lv_font_load_bin(gui_get_res_path(GUI_RES_MONTSERRATMEDIUM_30_TTF));
#endif
    if (fnt_font != NULL) {
        ...
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\project\\meter_ui_demo\\WL83_gitlab\\ac792\\ui_prj\\new_ui\\sdk\\ui_res\\flash\\rle\\font\\3500000c.rle");
#else
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", gui_get_res_path(GUI_RES_MONTSERRATMEDIUM_30_TTF));
#endif
    }
}
...
#else
    lv_font_t *fnt_font = lv_font_load_bin(gui_get_res_path(GUI_RES_MONTSERRATMEDIUM_28_TTF));
#endif
    if (fnt_font != NULL) {
        lv_font_montserratMedium_28 = *fnt_font;
    } else {
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\project\\meter_ui_demo\\WL83_gitlab\\ac792\\ui_prj\\new_ui\\sdk\\ui_res\\flash\\rle\\font\\3500000e.rle");
#else
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", gui_get_res_path(GUI_RES_MONTSERRATMEDIUM_28_TTF));
#endif
    }
}
