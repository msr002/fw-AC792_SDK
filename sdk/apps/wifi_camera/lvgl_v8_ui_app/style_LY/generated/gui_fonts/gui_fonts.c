...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000000.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000000.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000001.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000001.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000002.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000002.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000003.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000003.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000004.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000004.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000005.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000005.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000006.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000006.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000007.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000007.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000008.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000008.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000009.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\35000009.rle");
#else
...
{
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_font_t *fnt_font = lv_font_load_bin("A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\3500000a.rle");
#else
...
#if LV_USE_GUIBUILDER_SIMULATOR
        LV_LOG_ERROR("Load Fnt Font Failed %s\n", "A:\\1111\\ac792\\ui_prj\\dvr_ly_800x480\\sdk\\ui_res\\rle\\font\\3500000a.rle");
#else
