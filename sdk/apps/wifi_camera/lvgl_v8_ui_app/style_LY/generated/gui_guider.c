...
gui_scr_t *ui_get_scr(int32_t scr_id)
{
    ...
    if (scr_id == GUI_SCREEN_VIDEO_DEC) {
        return gui_scr_create(GUI_SCREEN_VIDEO_DEC, "video_dec", guider_ui.video_dec, (gui_scr_setup_cb_t)setup_scr_video_dec, (gui_scr_unload_cb_t)unload_scr_video_dec);
    }
    if (scr_id == GUI_SCREEN_VIDEO_DEC_OPTIONS) {
        return gui_scr_create(GUI_SCREEN_VIDEO_DEC_OPTIONS, "video_dec_options", guider_ui.video_dec_options, (gui_scr_setup_cb_t)setup_scr_video_dec_options, (gui_scr_unload_cb_t)unload_scr_video_dec_options);
    }
    return NULL;
}
