...
typedef enum {
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SUBPAGE_ICON = 0x000B,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_FUNCKEY1 = 0x000C,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_FUNCKEY2 = 0x000D,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_FUNCKEY3 = 0x000E,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_FUNCKEY4 = 0x000F,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_TITLE = 0x0010,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_HIDE_FUNCKEY1 = 0x0011,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_HIDE_FUNCKEY2 = 0x0012,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_HIDE_FUNCKEY3 = 0x0013,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_HIDE_FUNCKEY4 = 0x0014,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SHOW_FUNCKEY1 = 0x0015,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SHOW_FUNCKEY2 = 0x0016,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SHOW_FUNCKEY3 = 0x0017,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SHOW_FUNCKEY4 = 0x0018,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_ROLLER_OPT = 0x0019,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_SHOW_ROLLER = 0x001A,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_HIDE_ROLLER = 0x001B,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_STATE_FUNKEY1 = 0x001C,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_STATE_FUNKEY2 = 0x001D,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_STATE_FUNKEY3 = 0x001E,
    GUI_MODEL_GLOBAL_SUBPAGE_MSG_ID_STATE_FUNKEY4 = 0x0069,
