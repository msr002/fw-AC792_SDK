...
typedef enum {
    GUI_MODEL_MSG_ID_CUR_TIME = 0x0001,
    GUI_MODEL_MSG_ID_PREV_FILE = 0x0002,
    GUI_MODEL_MSG_ID_NEXT_FILE = 0x0003,
    GUI_MODEL_MSG_ID_VIDEO_PAUSE = 0x0004,
    GUI_MODEL_MSG_ID_CUR_TIME_PROCESS = 0x0005,
    GUI_MODEL_MSG_ID_FILE_NAME = 0x0006,
    GUI_MODEL_MSG_ID_TOTAL_TIME = 0x0007,
    GUI_MODEL_MSG_ID_FILE_PATH = 0x0008,
    GUI_MODEL_MSG_ID_FILE_NUM = 0x0009,
    GUI_MODEL_MSG_ID_MUSIC_STATE = 0x006A,
} gui_model_msg_id_t;
