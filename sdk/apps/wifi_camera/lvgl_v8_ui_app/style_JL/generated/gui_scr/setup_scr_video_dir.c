...
lv_obj_t *setup_scr_video_dir(lv_ui *ui)
{
    ...
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\RETURN.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\return_on.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\RETURN.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\return_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000057.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000058.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000057.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_4, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000058.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\EDIT.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\editor_on.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\EDIT.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\editor_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005d.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005e.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005d.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005e.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\LOCK.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\lock_on.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\LOCK.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\lock_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005f.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000060.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005f.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000060.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\DELETE.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\delete_on.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\DELETE.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\delete_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000063.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000064.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000063.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_5, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000064.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\HOME.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\home_on.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\HOME.png", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\home_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000061.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000062.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000061.rle", NULL);
    lv_imgbtn_set_src(ui->video_dir_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000062.rle", NULL);
#endif
