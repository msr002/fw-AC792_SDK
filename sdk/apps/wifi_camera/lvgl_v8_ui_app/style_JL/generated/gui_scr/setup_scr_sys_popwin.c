...
lv_obj_t *setup_scr_sys_popwin(lv_ui *ui)
{
    ...
    if (sys_popwin_lbl_1_font == NULL) {
        sys_popwin_lbl_1_font = &lv_font_FangZhengKaiTiJianTi_1_16;
    }
    ...
    if (sys_popwin_btn_1_font == NULL) {
        sys_popwin_btn_1_font = &lv_font_montserratMedium_16;
    }
    ...
    if (sys_popwin_btn_2_font == NULL) {
        sys_popwin_btn_2_font = &lv_font_montserratMedium_16;
    }
