...
lv_obj_t *setup_scr_home_page(lv_ui *ui)
{
    ...
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\video.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\video__on.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\video.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\video__on.png", NULL);
#else
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000029.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002a.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000029.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002a.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\file.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\file_on.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\file.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\file_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002b.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002c.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002b.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002c.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\setting.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\setting_on.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\setting.png", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\main_page\\setting_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002d.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002e.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002d.rle", NULL);
    lv_imgbtn_set_src(ui->home_page_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600002e.rle", NULL);
#endif
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->home_page_img_1, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_page\\battery\\full.png");
#else
    lv_img_set_src(ui->home_page_img_1, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000014.rle");
#endif
    ...
    lv_label_set_text(ui->home_page_lbl_3, "特晴");
    ...
    lv_obj_set_style_text_font(ui->home_page_lbl_3, &lv_font_FangZhengKaiTiJianTi_1_48, LV_PART_MAIN | LV_STATE_DEFAULT);
