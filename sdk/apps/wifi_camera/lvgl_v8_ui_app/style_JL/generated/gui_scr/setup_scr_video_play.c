...
lv_obj_t *setup_scr_video_play(lv_ui *ui)
{
    ...
    lv_obj_add_style(ui->video_play, &gui_scr_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->video_play, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_play_view_1, &gui_cont_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->video_play_view_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->video_play_view_1, LV_BORDER_SIDE_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_outline_opa(ui->video_play_view_1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_play_imgbtn_pause, &gui_imgbtn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_imgbtn_pause. Part: LV_PART_MAIN, State: LV_STATE_PRESSED
    lv_obj_add_style(ui->video_play_imgbtn_pause, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);

    //Set style for video_play_imgbtn_pause. Part: LV_PART_MAIN, State: LV_STATE_CHECKED
    lv_obj_add_style(ui->video_play_imgbtn_pause, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);

    //Set style for video_play_imgbtn_pause. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_imgbtn_pause, &gui_imgbtn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_play_imgbtn_loud, &gui_imgbtn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_imgbtn_loud. Part: LV_PART_MAIN, State: LV_STATE_PRESSED
    lv_obj_add_style(ui->video_play_imgbtn_loud, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);

    //Set style for video_play_imgbtn_loud. Part: LV_PART_MAIN, State: LV_STATE_CHECKED
    lv_obj_add_style(ui->video_play_imgbtn_loud, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);

    //Set style for video_play_imgbtn_loud. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_imgbtn_loud, &gui_imgbtn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_play_ddlist_multi_spped, &gui_ddlist_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_grad_color(ui->video_play_ddlist_multi_spped, lv_color_make(0x00, 0x00, 0x00), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(lv_dropdown_get_list(ui->video_play_ddlist_multi_spped), &gui_ddlist_scrollbar_default_style, LV_PART_SCROLLBAR | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_play_bar_process, &gui_bar_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_bar_process. Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT
    lv_obj_add_style(ui->video_play_bar_process, &gui_bar_indicator_default_style, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_add_style(ui->video_play_imgbtn_1, &gui_imgbtn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_imgbtn_1. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_imgbtn_1, &gui_imgbtn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);

    //Set style for video_play_imgbtn_1. Part: LV_PART_MAIN, State: LV_STATE_PRESSED
    lv_obj_add_style(ui->video_play_imgbtn_1, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);

    //Set style for video_play_imgbtn_1. Part: LV_PART_MAIN, State: LV_STATE_CHECKED
    lv_obj_add_style(ui->video_play_imgbtn_1, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, gui_get_res_path(GUI_RES_PHOTO_PNG), NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, gui_get_res_path(GUI_RES_PHOTO_ON_PNG), NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, gui_get_res_path(GUI_RES_PHOTO_PNG), NULL);
    ...
    lv_obj_add_style(ui->video_play_imgbtn_2, &gui_imgbtn_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_imgbtn_2. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_imgbtn_2, &gui_imgbtn_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);

    //Set style for video_play_imgbtn_2. Part: LV_PART_MAIN, State: LV_STATE_PRESSED
    lv_obj_add_style(ui->video_play_imgbtn_2, &gui_imgbtn_main_pressed_style, LV_PART_MAIN | LV_STATE_PRESSED);

    //Set style for video_play_imgbtn_2. Part: LV_PART_MAIN, State: LV_STATE_CHECKED
    lv_obj_add_style(ui->video_play_imgbtn_2, &gui_imgbtn_main_checked_style, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, gui_get_res_path(GUI_RES_RETURN_PNG), NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, gui_get_res_path(GUI_RES_RETURN_ON_PNG), NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, gui_get_res_path(GUI_RES_RETURN_PNG), NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, gui_get_res_path(GUI_RES_RETURN_ON_PNG), NULL);
    ...
    lv_obj_add_style(ui->video_play_img_prev_file, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_img_prev_file. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_img_prev_file, &gui_img_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_add_style(ui->video_play_img_next_file, &gui_img_main_default_style, LV_PART_MAIN | LV_STATE_DEFAULT);

    //Set style for video_play_img_next_file. Part: LV_PART_MAIN, State: LV_STATE_FOCUS_KEY
    lv_obj_add_style(ui->video_play_img_next_file, &gui_img_main_focus_key_style, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
