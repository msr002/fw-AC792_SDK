...
lv_obj_t *setup_scr_video_play(lv_ui *ui)
{
    ...
    lv_obj_add_flag(ui->video_play_view_1, LV_OBJ_FLAG_EVENT_BUBBLE);
    lv_obj_clear_flag(ui->video_play_view_1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui->video_play_imgbtn_pause, LV_OBJ_FLAG_EVENT_BUBBLE);
    lv_group_add_obj(def_group, ui->video_play_imgbtn_pause);
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_play_imgbtn_pause, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_play.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_pause, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\video_pause.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_play_imgbtn_pause, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000051.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_pause, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000052.rle", NULL);
#endif
    ...
    lv_obj_add_flag(ui->video_play_imgbtn_loud, LV_OBJ_FLAG_EVENT_BUBBLE);
    lv_group_add_obj(def_group, ui->video_play_imgbtn_loud);
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_play_imgbtn_loud, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\volumeLouder_solid_1.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_loud, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\volumeMute_solid_1.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_play_imgbtn_loud, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000053.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_loud, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000054.rle", NULL);
#endif
    ...
    lv_obj_add_flag(ui->video_play_ddlist_multi_spped, LV_OBJ_FLAG_EVENT_BUBBLE);
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\PHOTO.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\photo_on.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\PHOTO.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\photo_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000055.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000056.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000055.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000056.rle", NULL);
#endif
    ...
    ui->video_play_imgbtn_2 = lv_imgbtn_create(ui->video_play);
    ...
    lv_obj_set_style_bg_color(ui->video_play_imgbtn_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_color(ui->video_play_imgbtn_2, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_width(ui->video_play_imgbtn_2, 2, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_outline_opa(ui->video_play_imgbtn_2, 128, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    ...
    lv_obj_set_style_text_align(ui->video_play_imgbtn_2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_img_recolor(ui->video_play_imgbtn_2, lv_color_make(0xFF, 0xE7, 0x00), LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_img_recolor_opa(ui->video_play_imgbtn_2, 128, LV_PART_MAIN | LV_STATE_FOCUS_KEY);
    lv_obj_set_style_img_opa(ui->video_play_imgbtn_2, 255, LV_PART_MAIN | LV_STATE_FOCUS_KEY);

    //Set style for video_play_imgbtn_2. Part: LV_PART_MAIN, State: LV_STATE_PRESSED
    lv_obj_set_style_radius(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_clip_corner(ui->video_play_imgbtn_2, true, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_color(ui->video_play_imgbtn_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_shadow_width(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_text_color(ui->video_play_imgbtn_2, lv_color_make(0xFF, 0x33, 0xFF), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_text_font(ui->video_play_imgbtn_2, &lv_font_montserratMedium_12, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_img_recolor(ui->video_play_imgbtn_2, lv_color_make(0x00, 0x00, 0x00), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_img_recolor_opa(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_img_opa(ui->video_play_imgbtn_2, 255, LV_PART_MAIN | LV_STATE_PRESSED);

    //Set style for video_play_imgbtn_2. Part: LV_PART_MAIN, State: LV_STATE_CHECKED
    lv_obj_set_style_radius(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_clip_corner(ui->video_play_imgbtn_2, true, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(ui->video_play_imgbtn_2, lv_color_make(0xff, 0xff, 0xff), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_width(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_color(ui->video_play_imgbtn_2, lv_color_make(0xFF, 0x33, 0xFF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_font(ui->video_play_imgbtn_2, &lv_font_montserratMedium_12, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_img_recolor(ui->video_play_imgbtn_2, lv_color_make(0x00, 0x00, 0x00), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_img_recolor_opa(ui->video_play_imgbtn_2, 0, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_img_opa(ui->video_play_imgbtn_2, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_pos(ui->video_play_imgbtn_2, 726, 260);
...
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\RETURN.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\return_on.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\RETURN.png", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\return_on.png", NULL);
#else
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000057.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000058.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000057.rle", NULL);
    lv_imgbtn_set_src(ui->video_play_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000058.rle", NULL);
#endif
    ...
    // Write Timer video_play_hide_bar
    if (ui->video_play_hide_bar != NULL) {
        lv_timer_del(ui->video_play_hide_bar);
    }
    ui->video_play_hide_bar = lv_timer_create(video_play_hide_bar_timer_cb, 3000, "");
    lv_timer_set_repeat_count(ui->video_play_hide_bar, -1);
    //Write codes video_play_img_prev_file
    ui->video_play_img_prev_file = lv_img_create(ui->video_play);
    ...
    lv_obj_set_pos(ui->video_play_img_prev_file, 25, 416);
    lv_obj_set_size(ui->video_play_img_prev_file, 57, 54);
    lv_obj_set_scrollbar_mode(ui->video_play_img_prev_file, LV_SCROLLBAR_MODE_OFF);
    lv_group_add_obj(def_group, ui->video_play_img_prev_file);
    lv_obj_add_flag(ui->video_play_img_prev_file, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->video_play_img_prev_file, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\skip_previous.png");
#else
    lv_img_set_src(ui->video_play_img_prev_file, "mnt/sdfile/EXT_RESERVED/uipackres/ui/56000059.rle");
#endif
    ...
    ui->video_play_img_next_file = lv_img_create(ui->video_play);
    ...
    lv_obj_set_pos(ui->video_play_img_next_file, 150, 416);
    lv_obj_set_size(ui->video_play_img_next_file, 57, 54);
    lv_obj_set_scrollbar_mode(ui->video_play_img_next_file, LV_SCROLLBAR_MODE_OFF);
    lv_group_add_obj(def_group, ui->video_play_img_next_file);
    lv_obj_add_flag(ui->video_play_img_next_file, LV_OBJ_FLAG_CLICKABLE);
#if LV_USE_GUIBUILDER_SIMULATOR
    lv_img_set_src(ui->video_play_img_next_file, "A:\\wl83\\wifi_video_master\\ui_prj\\dvr_800x480\\import\\image\\skip_next.png");
#else
    lv_img_set_src(ui->video_play_img_next_file, "mnt/sdfile/EXT_RESERVED/uipackres/ui/5600005a.rle");
#endif
    ...
    // Write Timer video_play_hide_label
    if (ui->video_play_hide_label != NULL) {
        lv_timer_del(ui->video_play_hide_label);
    }
    ui->video_play_hide_label = lv_timer_create(video_play_hide_label_timer_cb, 100, "");
    lv_timer_set_repeat_count(ui->video_play_hide_label, -1);
...
void unload_scr_video_play(lv_ui *ui)
{
    if (ui->video_play_hide_bar != NULL) {
        lv_timer_del(ui->video_play_hide_bar);
        ui->video_play_hide_bar = NULL;
    }
    if (ui->video_play_hide_label != NULL) {
        lv_timer_del(ui->video_play_hide_label);
        ui->video_play_hide_label = NULL;
    }
