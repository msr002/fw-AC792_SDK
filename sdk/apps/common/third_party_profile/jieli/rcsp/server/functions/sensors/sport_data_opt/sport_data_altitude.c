...
#pragma bss_seg(".sport_data_altitude.data.bss")
#pragma data_seg(".sport_data_altitude.data")
#pragma const_seg(".sport_data_altitude.text.const")
#pragma code_seg(".sport_data_altitude.text")
#endif
