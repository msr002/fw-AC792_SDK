...
#pragma bss_seg(".sport_data_heart_rate.data.bss")
#pragma data_seg(".sport_data_heart_rate.data")
#pragma const_seg(".sport_data_heart_rate.text.const")
#pragma code_seg(".sport_data_heart_rate.text")
#endif
