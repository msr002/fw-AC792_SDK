...
#pragma bss_seg(".sport_data_blood_oxygen.data.bss")
#pragma data_seg(".sport_data_blood_oxygen.data")
#pragma const_seg(".sport_data_blood_oxygen.text.const")
#pragma code_seg(".sport_data_blood_oxygen.text")
#endif
