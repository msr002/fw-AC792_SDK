...
#pragma bss_seg(".sport_data_air_pressure.data.bss")
#pragma data_seg(".sport_data_air_pressure.data")
#pragma const_seg(".sport_data_air_pressure.text.const")
#pragma code_seg(".sport_data_air_pressure.text")
#endif
