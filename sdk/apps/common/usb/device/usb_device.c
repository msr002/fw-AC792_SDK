...
#error "USB_SPEED_MODE not defined"
    ...
    usb_set_dma_taddr(usb_id, 0, ep0_dma_buffer[usb_id]);
    usb_set_dma_raddr(usb_id, 1, ep0_dma_buffer[usb_id]);
    usb_set_dma_taddr(usb_id, 1, ep0_dma_buffer[usb_id]);
    usb_set_dma_raddr(usb_id, 2, ep0_dma_buffer[usb_id]);
    usb_set_dma_taddr(usb_id, 2, ep0_dma_buffer[usb_id]);
    usb_set_dma_raddr(usb_id, 3, ep0_dma_buffer[usb_id]);
    usb_set_dma_taddr(usb_id, 3, ep0_dma_buffer[usb_id]);
    usb_set_dma_raddr(usb_id, 4, ep0_dma_buffer[usb_id]);
    usb_set_dma_taddr(usb_id, 4, ep0_dma_buffer[usb_id]);
    if (usb_id == 1) {
        usb_set_dma_raddr(usb_id, 5, ep0_dma_buffer[usb_id]);
        usb_set_dma_taddr(usb_id, 5, ep0_dma_buffer[usb_id]);
        usb_set_dma_raddr(usb_id, 6, ep0_dma_buffer[usb_id]);
        usb_set_dma_taddr(usb_id, 6, ep0_dma_buffer[usb_id]);
    }
