...
/*
               CLASS  BITMAP
    7   |   6   |   5   |   4   |   3   |   2   |   1   |   0
                   UVC     CDC     HID    AUDIO  SPEAKER   Mass Storage
*/
/**************************************************************************/
...
#endif
#ifndef TCFG_HOST_HUB_ENABLE
#define TCFG_HOST_HUB_ENABLE   0
#endif
/********************************/
...
#define TCFG_UDISK_ENABLE					DISABLE_THIS_MOUDLE//U盘模块使能
	...
	TCFG_HOST_UVC_ENABLE || TCFG_HOST_WIRELESS_ENABLE || TCFG_HOST_RNDIS_ENABLE || TCFG_HOST_CDC_ENABLE || TCFG_HOST_HUB_ENABLE
...
#if (USB_DEVICE_CLASS_CONFIG & MASSSTORAGE_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & MASSSTORAGE_CLASS)
#define TCFG_USB_SLAVE_MSD_ENABLE           1
#else
#define TCFG_USB_SLAVE_MSD_ENABLE           0
#endif

#if (USB_DEVICE_CLASS_CONFIG & AUDIO_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & AUDIO_CLASS)
#define TCFG_USB_SLAVE_AUDIO_ENABLE         1
#else
#define TCFG_USB_SLAVE_AUDIO_ENABLE         0
#endif

#if (USB_DEVICE_CLASS_CONFIG & HID_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & HID_CLASS)
#define TCFG_USB_SLAVE_HID_ENABLE           1
#else
#define TCFG_USB_SLAVE_HID_ENABLE           0
#endif

#if (USB_DEVICE_CLASS_CONFIG & CUSTOM_HID_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & CUSTOM_HID_CLASS)
...
#if (USB_DEVICE_CLASS_CONFIG & CDC_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & CDC_CLASS)
#define TCFG_USB_SLAVE_CDC_ENABLE           1
#else
#define TCFG_USB_SLAVE_CDC_ENABLE           0
#endif

#if (USB_DEVICE_CLASS_CONFIG & UVC_CLASS) || (USB_DEVICE_CLASS_CONFIG_2_0 & UVC_CLASS)
