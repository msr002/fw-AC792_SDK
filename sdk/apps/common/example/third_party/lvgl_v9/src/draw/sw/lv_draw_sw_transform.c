    ...
    for (x = 0; x < x_end; x++) {
        ...
        if (aa &&
            ...
            if (src_has_a8) {
                ...
                if (a_ver != abuf[x]) {
                    a_ver = ((a_ver * ys_fract) + (abuf[x] * (0x100 - ys_fract))) >> 8;
                }
                if (a_hor != abuf[x]) {
                    a_hor = ((a_hor * xs_fract) + (abuf[x] * (0x100 - xs_fract))) >> 8;
                }
                                 ...
                                 int32_t x_end, uint8_t *dest_buf, bool aa)
{
    ...
    for (x = 0; x < x_end; x++) {
        ...
        if (aa &&
            ...
            if (a_ver != dest_al88[x].lumi) {
                a_ver = ((a_ver * ys_fract) + (dest_al88[x].lumi * (0x100 - ys_fract))) >> 8;
            }
            if (a_hor != dest_al88[x].lumi) {
                a_hor = ((a_hor * xs_fract) + (dest_al88[x].lumi * (0x100 - xs_fract))) >> 8;
            }
                                     ...
                                     int32_t x_end, uint8_t *dest_buf, bool aa)
{
    ...
    for (x = 0; x < x_end; x++) {
        ...
        if (aa &&
            ...
            if (a_ver != src_tmp[0]) {
                a_ver = ((a_ver * ys_fract) + (src_tmp[0] * (0x100 - ys_fract))) >> 8;
            }
            if (a_hor != src_tmp[0]) {
                a_hor = ((a_hor * xs_fract) + (src_tmp[0] * (0x100 - xs_fract))) >> 8;
            }
