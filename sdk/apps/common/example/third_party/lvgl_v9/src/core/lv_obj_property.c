    ...
    for (clz = obj->class_p ; clz; clz = clz->base_class) {
        ...
        for (uint32_t i = 0; i < clz->properties_count; i++) {
            ...
            if (prop->id == LV_PROPERTY_ID_ANY) {
                value->id = prop->id;
                if (set) {
                    return ((lv_property_setter_t)prop->setter)(obj, id, value);
                } else {
                    return ((lv_property_getter_t)prop->getter)(obj, id, value);
                }
            }
            ...
            case LV_PROPERTY_TYPE_INT: {
                if (set) {
                    ((lv_property_set_int_t)(prop->setter))(obj, value->num);
                } else {
                    value->num = ((lv_property_get_int_t)(prop->getter))(obj);
                }
                break;
            }
            case LV_PROPERTY_TYPE_BOOL: {
                if (set) {
                    ((lv_property_set_bool_t)(prop->setter))(obj, value->enable);
                } else {
                    value->enable = ((lv_property_get_bool_t)(prop->getter))(obj);
                }
                break;
            }
            ...
            case LV_PROPERTY_TYPE_PRECISE: {
                if (set) {
                    ((lv_property_set_precise_t)(prop->setter))(obj, value->precise);
                } else {
                    value->precise = ((lv_property_get_precise_t)(prop->getter))(obj);
                }
                break;
            }
            case LV_PROPERTY_TYPE_COLOR: {
                if (set) {
                    ((lv_property_set_color_t)prop->setter)(obj, value->color);
                } else {
                    value->color = ((lv_property_get_color_t)(prop->getter))(obj);
                }
                break;
            }
            case LV_PROPERTY_TYPE_POINT: {
                ...
                if (set) {
                    ((lv_property_set_point_t)(prop->setter))(obj, point);
                } else {
                    *point = ((lv_property_get_point_t)(prop->getter))(obj);
                }
                break;
            }
            ...
            case LV_PROPERTY_TYPE_FONT: {
                if (set) {
                    ((lv_property_set_pointer_t)(prop->setter))(obj, value->ptr);
                } else {
                    value->ptr = ((lv_property_get_pointer_t)(prop->getter))(obj);
                }
                break;
            }
            default: {
