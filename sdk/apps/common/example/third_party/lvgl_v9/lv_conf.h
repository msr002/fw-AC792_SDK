...
#define LV_COLOR_DEPTH 32
#else
#error "LVGL_V9 NOT SUPPORT TCFG_LCD_RGB_INPUT_FORMAT"
#endif
...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN //用系统会同时调用putchar打印一些东西出来
...
#define BOOL_DEFINE_CONFLICT
#define LV_OS_CUSTOM_INCLUDE "lv_os_jieli.h"
#endif
...
#define LV_DRAW_SW_SHADOW_CACHE_SIZE 512
...
#define LV_VG_LITE_THORVG_YUV_SUPPORT 1
...
#define LV_PROFILER_BUILTIN_BUF_SIZE (64 * 1024)     /*[bytes]*/
#endif
