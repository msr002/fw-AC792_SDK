...
#error "lv_btnm is required. Enable it in lv_conf.h (LV_USE_BTNMATRIX  1) "
#endif

#if LV_USE_TEXTAREA == 0
#error "lv_ta is required. Enable it in lv_conf.h (LV_USE_TEXTAREA  1) "
#endif
 ...
 * @param ctrl_map  See 'lv_btnmatrix_set_ctrl_map()' for more info.
 ...
 */
static inline uint32_t lv_keyboard_get_selected_btn(const lv_obj_t *obj)
{
 ...
 */
static inline const char *lv_keyboard_get_btn_text(const lv_obj_t *obj, uint32_t btn_id)
{
