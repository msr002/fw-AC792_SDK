...
#elif !defined TCFG_LCD_RGB_INPUT_FORMAT
#error "MUST DEFINE TCFG_LCD_RGB_INPUT_FORMAT"
#elif TCFG_LCD_RGB_INPUT_FORMAT == LCD_IN_RGB565
#define LV_COLOR_DEPTH 16
...
#define LV_COLOR_DEPTH 16
#else
#error "LVGL_V8 NOT SUPPORT TCFG_LCD_RGB_INPUT_FORMAT"
#endif
...
#if LV_TICK_CUSTOM
#define LV_TICK_CUSTOM_INCLUDE "string.h"         /*Header for the system time function*/
#ifndef LV_USE_GUIBUILDER_SIMULATOR
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (timer_get_ms())    /*Expression evaluating to current system time in ms*/
#else
#define LV_TICK_CUSTOM_INCLUDE <sysinfoapi.h>         /*Header for the system time function*/
 ...
 *-----------*/
/*Use JL's DMA2D & GPU*/
#define LV_USE_GPU_JL 1

#if LV_USE_GPU_JL
#define LV_USE_GPU_JL_DMA2D 1   /* Enable DMA2D rendering */

#define LV_USE_GPU_JL_GPU2P5D 1 /* Enable GPU2P5D rendering */
#if LV_USE_GPU_JL_GPU2P5D
#define LV_USE_JL_GPU2P5D_DRAW_LINE 1
#define LV_USE_JL_GPU2P5D_DRAW_RECT 0
#define LV_USE_JL_GPU2P5D_DRAW_ARC 1
#define LV_USE_JL_GPU2P5D_DRAW_POLYGON 1
#define LV_USE_JL_GPU2P5D_DRAW_IMG 1
#define LV_USE_JL_GPU2P5D_DRAW_LETTER 1
#endif
#endif
...
#endif
#define LV_USE_MEM_MONITOR_JUST_PRINTF 1
