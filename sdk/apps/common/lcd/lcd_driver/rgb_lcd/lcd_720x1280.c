...
static void lcd_720x1280_backctrl(void *_data, u8 on)
{
...
static int lcd_720x1280_init(void *_data)
{
    printf("lcd 720x1280 init ...\n");

    return 0;
}


REGISTER_IMD_DEVICE_BEGIN(lcd_720x1280_dev) = {
    .info = {
#ifdef USE_TEST_MODE
        .test_mode 	     = true,
#else
...
REGISTER_LCD_DEVICE_DRIVE(lcd_dev)  = {
    .logo       = "lcd_720x1280",
    .type		= LCD_RGB,
    .init		= lcd_720x1280_init,
    .dev    	= &lcd_720x1280_dev,
    .bl_ctrl	= lcd_720x1280_backctrl,
};
