...
static void lcd_800x480_backctrl(void *_data, u8 on)
{
...
static int lcd_800x480_init(void *_data)
{
    printf("lcd_800x480 init ...\n");

    return 0;
}


REGISTER_IMD_DEVICE_BEGIN(lcd_800x480_dev) = {
    .info = {
#ifdef USE_TEST_MODE
        .test_mode 	     = true,
#else
...
REGISTER_LCD_DEVICE_DRIVE(lcd_dev) = {
    .logo       = "lcd_800x480",
    .type       = LCD_RGB,
    .init       = lcd_800x480_init,
    .dev        = &lcd_800x480_dev,
    .bl_ctrl    = lcd_800x480_backctrl,
};
