...
#define RES     TCFG_LCD_RESET_IO
#define CS      TCFG_LCD_CS_IO
#define SDI     TCFG_LCD_SDA_IO
#define SCL     TCFG_LCD_SCL_IO

#define delay_ms    msleep

static void lcd_480x800_backctrl(void *_data, u8 on)
{
...
static int lcd_480x800_init(void *_data)
{
    printf("lcd 480x800 init ...\n");
...
REGISTER_IMD_DEVICE_BEGIN(lcd_480x800_dev) = {
    .info = {
#ifdef USE_TEST_MODE
        .test_mode 	     = true,
#else
...
REGISTER_LCD_DEVICE_DRIVE(lcd_dev) = {
    .logo       = "lcd_480x800",
    .type       = LCD_RGB,
    .init       = lcd_480x800_init,
    .dev        = &lcd_480x800_dev,
    .bl_ctrl    = lcd_480x800_backctrl,
};
