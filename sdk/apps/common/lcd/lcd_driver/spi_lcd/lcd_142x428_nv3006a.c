...
static int lcd_spi_142x428_nv3006a_init(void *arg)
{
    ...
    printf("[LCD]nv3006a 142x428 spi lcd succes\n");
...
static void lcd_spi_142x428_nv3006a_bl_ctrl(void *_data, u8 onoff)
{
