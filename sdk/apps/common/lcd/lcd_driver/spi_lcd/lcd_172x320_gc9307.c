...
{
    /* printf("[LCD]gc9307 172x320 spi lcd reset\n"); */
    lcd_rst_pinstate(1);
    lcd_rs_pinstate(0);
    lcd_cs_pinstate(1);
...
static int lcd_spi_172x320_gc9307_init(void *arg)
{
    ...
    printf("[LCD]gc9307 172x320 spi lcd succes\n");
...
static void lcd_spi_172x320_gc9307_bl_ctrl(void *_data, u8 onoff)
{
