...
void lv_imagebutton_set_state(lv_obj_t *obj, lv_imagebutton_state_t state)
{
    ...
    if (state == LV_IMAGEBUTTON_STATE_PRESSED ||
        state == LV_IMAGEBUTTON_STATE_CHECKED_PRESSED) {
        obj_state |= LV_STATE_PRESSED;
    }
    if (state == LV_IMAGEBUTTON_STATE_DISABLED ||
        state == LV_IMAGEBUTTON_STATE_CHECKED_DISABLED) {
...
static lv_imagebutton_state_t suggest_state(lv_obj_t *obj, lv_imagebutton_state_t state)
{
    ...
    if (imagebutton->src_mid[state].img_src == NULL) {
        ...
        case LV_IMAGEBUTTON_STATE_PRESSED:
            if (imagebutton->src_mid[LV_IMAGEBUTTON_STATE_RELEASED].img_src) {
        ...
        case LV_IMAGEBUTTON_STATE_CHECKED_PRESSED:
            if (imagebutton->src_mid[LV_IMAGEBUTTON_STATE_CHECKED_RELEASED].img_src) {
                return LV_IMAGEBUTTON_STATE_CHECKED_RELEASED;
            }
            if (imagebutton->src_mid[LV_IMAGEBUTTON_STATE_PRESSED].img_src) {
                return LV_IMAGEBUTTON_STATE_PRESSED;
            }
            if (imagebutton->src_mid[LV_IMAGEBUTTON_STATE_RELEASED].img_src) {
                return LV_IMAGEBUTTON_STATE_RELEASED;
            }
...
static lv_imagebutton_state_t get_state(const lv_obj_t *imagebutton)
{
    ...
    if (obj_state & LV_STATE_DISABLED) {
        if (obj_state & LV_STATE_CHECKED) {
            return LV_IMAGEBUTTON_STATE_CHECKED_DISABLED;
        } else {
            return LV_IMAGEBUTTON_STATE_DISABLED;
        }
    }
