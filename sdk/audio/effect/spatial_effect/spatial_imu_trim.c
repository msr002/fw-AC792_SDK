...
#pragma bss_seg(".spatial_imu_trim.data.bss")
#pragma data_seg(".spatial_imu_trim.data")
#pragma const_seg(".spatial_imu_trim.text.const")
#pragma code_seg(".spatial_imu_trim.text")
#endif
...
static int app_spatial_imu_trim_msg_handler(int *msg)
{
    switch (msg[0]) {
    case APP_MSG_IMU_TRIM_START:
        spatial_imu_trim_task_start();
        break;
    case APP_MSG_IMU_TRIM_STOP:
...
APP_MSG_HANDLER(app_imu_trim_msg_entry) = {
    .owner      = 0xff,
    .from       = MSG_FROM_APP,
    .handler    = app_spatial_imu_trim_msg_handler,
};
