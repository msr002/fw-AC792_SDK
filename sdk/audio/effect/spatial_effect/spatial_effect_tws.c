...
#pragma bss_seg(".spatial_effect_tws.data.bss")
#pragma data_seg(".spatial_effect_tws.data")
#pragma const_seg(".spatial_effect_tws.text.const")
#pragma code_seg(".spatial_effect_tws.text")
#endif
/*****************************************************************
