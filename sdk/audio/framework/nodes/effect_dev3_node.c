 ...
 * */
static void audio_effect_dev3_run(struct effect_dev3_node_hdl *hdl, s16 *indata, s16 *outdata, u32 indata_len)
{
#if 0
    //test 2to4
...
static void effect_dev3_ioc_start(struct effect_dev3_node_hdl *hdl)
{
    ...
    hdl->dev.effect_run = (void (*)(void *, s16 *, s16 *, u32))audio_effect_dev3_run;
