...
#pragma bss_seg(".audio_export_demo.data.bss")
#pragma data_seg(".audio_export_demo.data")
#pragma const_seg(".audio_export_demo.text.const")
#pragma code_seg(".audio_export_demo.text")
#endif
...
int audio_export_demo_init()
{
    ...
    aec_uart_open(3, 512);    //uart export 初始化
