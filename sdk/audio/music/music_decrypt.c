...
#pragma bss_seg(".music_decrypt.data.bss")
#pragma data_seg(".music_decrypt.data")
#pragma const_seg(".music_decrypt.text.const")
#pragma code_seg(".music_decrypt.text")
#endif
...
void cipher_check_decode_file(CIPHER *pcipher, void *file)
{
    ...
    u8 *ext_name = (u8 *) strrchr((const char *)name, '.');
    if (ext_name == NULL) {
        // 可能是83结构文件名
